				...
				<div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li class="submenu">
								<a href="#"><i data-feather="users"></i> <span> User Management</span> <span class="menu-arrow"></span></a>
								<ul>
									<li><a href="{{url('/admin/users/activeDesigner')}}">Active Designers</a></li>
									<li><a href="{{url('/admin/users/inactiveDesigner')}}">Inactive Designers</a></li>
									
									<li><a href="{{url('/admin/users/inactiveSeller')}}">Active Seller</a></li>
									
									<li><a href="{{url('/admin/users/inactiveSeller')}}">Inactive Seller</a></li>
