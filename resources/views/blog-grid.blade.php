									...
									<div class="blog grid-blog">
										...
										<div class="blog-content">
											<ul class="entry-meta meta-item">
												<li>
													<div class="post-author">
														<a href="designer-details"><img src="assets/img/img-05.jpg" alt="Post Author"> <span>Sofia Brient</span></a>
													</div>
												</li>
									...
									<div class="blog grid-blog">
										...
										<div class="blog-content">
											<ul class="entry-meta meta-item">
												<li>
													<div class="post-author">
														<a href="designer-details"><img src="assets/img/img-02.jpg" alt="Post Author"> <span>Marvin Campbell</span></a>
													</div>
												</li>
												<li><i class="far fa-clock"></i> 1 Dec 2021</li>
											</ul>
											<h3 class="blog-title"><a href="blog-details">How to crack the interview easily - Kofejob</a></h3>
											<p class="mb-0">Lorem ipsum dolor sit amet, consectetur em adipiscing elit, sed do eiusmod tempor.</p>
										</div>
									</div>
									<!-- /Blog Post -->
									...
									<div class="blog grid-blog">
										...
										<div class="blog-content">
											<ul class="entry-meta meta-item">
												<li>
													<div class="post-author">
														<a href="designer-details"><img src="assets/img/img-03.jpg" alt="Post Author"> <span> Paul Berthold</span></a>
													</div>
												</li>
