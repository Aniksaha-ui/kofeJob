					...
					<div class="row">
								...
								<div class="filter-widget">
									...
									<div class="form-group">
										<select class="form-control select">
											...
											<option>React designer</option>
											<option>.Net designer</option>
										</select>
									</div>
								</div>
								<div class="filter-widget">
						...
						<div class="col-md-12 col-lg-8 col-xl-9">
							...
							<div class="bootstrap-tags text-start pl-0">
								<span class="badge badge-pill badge-skills">UI/UX designer <span class="tag-close" data-role="remove"><i class="fas fa-times"></i></span></span> 
