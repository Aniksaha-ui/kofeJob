						...
						<div class="col-md-8">
							<div class="terms-content">
								<div class="terms-text">
									...
									<p>Thanks for using our products and services ("Services"). The Services are provided by Pixeel Ltd. ("Kofejob"), located at 153 Williamson Plaza, Maggieberg, MT 09514, England, United Kingdom.</p>
								...
								<div class="terms-text">
									...
									<p>When you register for a Kofejob account we collect your full name, email address, and account log-in credentials.</p>
									...
									<p>When you use the "Remember Me" feature of Kofejob Checkout, we collect your email address, payment card number, CVC code and expiration date.</p>
									<p>When you respond to Kofejob emails or surveys we collect your email address, name and any other information you choose to include in the body of your email or responses. If you contact us by phone, we will collect the phone number you use to call Kofejob. If you contact us by phone as a Kofejob User, we may collect additional information in order to verify your identity.</p>
								</div>
								...
								<div class="terms-text">
									...
									<p>We also may collect information about your online activities on websites and connected </p>
							...
							<div class="card list-widget">
								...
								<div class="card-body">
									<ul class="list-group list-group-flush">
										<li class="list-group-item"><a href="#">1. Using our services</a>
											<ul>
												<li><a href="#">A. Personal Data that we collect about you</a></li>
												<li><a href="#">B. Information that we collect automatically on our Sites</a></li>
											</ul>
										</li>
										<li class="list-group-item"><a href="#">2. Privacy and copyright protection</a></li>
										<li class="list-group-item"><a href="#">3. Your content in our services</a></li>
									</ul>
								</div>
							</div>
						</div>
