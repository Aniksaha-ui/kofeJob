															...
															<form>
																<div class="form-row">
																	<div class="form-group col-lg-4">
																		...
																		<input type="text" class="form-control" placeholder="IOS designer">
																	</div>
																	<div class="form-group col-lg-4">
							...
							<div class="pro-post">	
								<div class="follow-widget">
									<div class="text-end custom-edit-btn">												
										<a href="designer-profile-settings" class="sub-title"><i class="fa fa-pencil-alt me-1"></i></a>
									</div>
