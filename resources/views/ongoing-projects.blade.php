						...
						<div class="col-xl-9 col-md-8">
							...
							<nav class="user-tabs project-tabs">
								<ul class="nav nav-tabs nav-tabs-bottom nav-justified">
									...
									<li class="nav-item">
										<a class="nav-link active" href="ongoing-projects">Ongoing Projects</a>
									</li>
									<li class="nav-item">
										...
										<div class="projects-card flex-fill">
											<div class="card-body">
												<div class="projects-details align-items-center">
													<div class="project-info">
														<span>Dreamguystech</span>
														<h2>PHP Laravel designer Required (Contractual Employement)</h2>
														<div class="customer-info">
															<ul class="list-details">
																<li>
																	<div class="slot">
										...
										<div class="projects-card flex-fill">
											<div class="card-body">
												<div class="projects-details align-items-center">
													<div class="project-info">
														<span>Dreamguystech</span>
														<h2>Laravel Backend designer to finish ongoing project</h2>
														<div class="customer-info">
															<ul class="list-details">
																<li>
																	<div class="slot">
